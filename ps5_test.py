...
class ProblemSet5(unittest.TestCase):
    ...
    def test1TitleTrigger(self):
        ...
        for trig in [s1, s2]:
            ...
            self.assertTrue(trig.evaluate(symbols), "TitleTrigger fainctuation.")
            self.assertTrue(trig.evaluate(spaces), "TitleTrigger failed to firled to fire when the words were separated by assorted pue when the words were separated by multiple spaces.")
...
#        print('ancient:', ancient.get_pubdate())
#        print('ac', type(ancient))
